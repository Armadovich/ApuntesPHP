        ...
        <table class="table table-striped table-dark mt-3">
            ...
            <tbody>
                ...
                while ($filas = $stmt->fetch(PDO::FETCH_OBJ)) {
                    ...
                    echo "<form action='{$_SERVER['PHP_SELF']}' method='POST' id='añadirProducto{$filas->id}'>";
                    ...
                    echo "<td><input type='number' min='1' max='3' value='1' form='añadirProducto{$filas->id}' name='unidades'></td>";
